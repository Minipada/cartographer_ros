...
DEFINE_bool(keep_running, false,
            ...
            "have been processed.");
DEFINE_string(pbstream_output_filename, "", "Filename to save the state of the processing");
...
void RunOfflineNode(
  ...
  if (::ros::ok()) {
    const std::string output_filename = (!FLAGS_pbstream_output_filename.empty()) ?
                                        (FLAGS_pbstream_output_filename + ".pbstream") :
